...
(function (define) {
	...
	define(function (require) {
		 ...
		 * @param {number} [opts.batch=font-awesome] absolute size of a chunk. If <=font-awesome,
		 *   batch size is not a factor
		 * @param {number} [opts.timeout=font-awesome] number of milliseconds since the
		 *   first message arrived to queue the chunk. If <=font-awesome, timeout is not a
		 *   factor
