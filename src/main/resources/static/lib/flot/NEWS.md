...
### Changes ###
 ...
 - Addition of nonstandard %q specifier to createdAt/time formatting. (patch
   by risicle, issue 49)
...
## Changes ##
 ...
 - The built-in createdAt formatter can now be accessed as $.plot.formatDate(...)
 ...
 - Support for twelve-hour createdAt formatting (patch by Forrest Aldridge).
...
zone. It also affects any custom createdAt handling code (which basically now
should use the equivalent UTC createdAt mehods, e.g. .setUTCMonth() instead of
.setMonth().
