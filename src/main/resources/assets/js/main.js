...
var Core = function(options) {
    ...
    var runTrays = function() {
        ...
        $( ".close-sidebar" ).on( "click", function() {
            $('.tray-right').toggleClass( "hide-sidebar" );
            $('.tray-center').toggleClass( "wide-content" );
            $('.close-sidebar .fa-times').toggleClass( "fa-filter" );
        });
        ...
        var rescale = function() {
            if ($(window).width() < 1100) {
                ...
                $('.tray-right').addClass( "hide-sidebar" );
                $('.tray-center').addClass( "wide-content" );
                $('.close-sidebar .fa-times').addClass( "fa-filter" );
            }
