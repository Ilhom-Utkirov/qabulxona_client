...
* Date.parse now supports simplified ISO8601 createdAt strings
* new Date() now supports simplified ISO8601 createdAt strings
* createdAt.toISOString() returns a simplified ISO8601 createdAt string
