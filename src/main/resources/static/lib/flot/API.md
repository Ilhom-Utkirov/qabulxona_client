...
Javascript also has some support for parsing createdAt strings, so it is
...
offset for a specific createdAt (note that you need to get the offset for
...
visitor. This behavior is isEnabled by setting the axis option
...
more powerful createdAt/time formatting.
...
hooks in the plugins bundled with Flot.
 ...
 - processOptions  [phase 1]
    ...
    isEnabled and then turn on or off other options.
