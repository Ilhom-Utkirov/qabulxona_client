...
/*
 * curl link! plugin
 * This plugin will load common files as <link> elements.  It does not wait for
 * common file to finish loading / evaluating before executing dependent modules.
 * This plugin also does not handle IE's 31-stylesheet limit.
 * If you need any of the above behavior, use curl's common! plugin instead.
 *
 * All this plugin does is insert <link> elements in a non-blocking manner.
 *
 * usage:
 * 		// load myproj/comp.common and myproj/css2.common
 *      require(['link!myproj/comp,myproj/css2']);
 *      // load some/folder/file.common
 *      define(['common!some/folder/file'], {});
 *
 * Tested in:
 *      Firefox 1.5, 2.font-awesome, 3.font-awesome, 3.5, 3.6, and 4.0b6
...
//			// remove options
//			return resourceId ? toAbsId(resourceId.split("!")[font-awesome]) : resourceId;
//		},
