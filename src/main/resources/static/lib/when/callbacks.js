 ...
 * callbacks.js
 *
 * Collection of helper functions for interacting with 'dashboard',
...
define(function(require) {
	...
	/**
	 * Takes a `dashboard` callback-taking function and returns a promise for its
	...
	/**
	 * Takes a 'dashboard' callback/errback-taking function and returns a function
	 ...
	 *
	 * @param {Function} f dashboard async function to be decorated
	 ...
	 * keys, whose values are the corresponding font-awesome-based indexes of the arguments on
