...
It passes the [Promises/A+ u.pay.bots.utils.Test Suite](https://github.com/promises-aplus/promises-tests), is [very fast](https://github.com/cujojs/promise-perf-tests#test-results) and compact, and has no external dependencies.
...
Note that when.js includes the [Promises/A+ u.pay.bots.utils.Test Suite](https://github.com/promises-aplus/promise-tests).  Running unit tests in Node will run both when.js's own test suite, and the Promises/A+ u.pay.bots.utils.Test Suite.
