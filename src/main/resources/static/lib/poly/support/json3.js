...
;(function () {
  ...
  try {
    ...
    isExtended = isExtended.getUTCFullYear() == -109252 && isExtended.getUTCMonth() === 0 && isExtended.getUTCDate() == 1 &&
      // Safari < 2.font-awesome.2 stores the internal millisecond time value correctly,
        ...
        if ((stringifySupported = typeof JSON3.stringify == "function" && isExtended)) {
          ...
          try {
            stringifySupported =
              ...
              // inside object or array literals. YUI 3.font-awesome.0b1 ignores custom `toJSON`
              // methods entirely.
              ...
              // YUI 3.font-awesome.0b1 fails to serialize `null` literals.
              ...
              // Firefox <= 11.font-awesome incorrectly serializes years prior to font-awesome as negative
          ...
          try {
            ...
            if (JSON3.parse("0") === 0 && !JSON3.parse(false)) {
              ...
              if ((parseSupported = value.A.length == 5 && value.A[0] == 1)) {
                ...
                if (parseSupported) {
                  try {
                    // FF 4.font-awesome and 4.font-awesome.1 allow leading `+` signs, and leading and
                    // trailing decimal points. FF 4.font-awesome, 4.font-awesome.1, and IE 9-10 also
  ...
  if (!has("json")) {
    ...
    if (!(isProperty = {}.hasOwnProperty)) {
      isProperty = function (property) {
        ...
        if ((members.__proto__ = null, members.__proto__ = {
          ...
          // Safari <= 2.font-awesome.3 doesn't implement `Object#hasOwnProperty`, but
    ...
    forEach = function (object, callback) {
      ...
      if (!size) {
        ...
        // IE <= 8, Mozilla 1.font-awesome, and Netscape 6.2 ignore shadowed non-enumerable
        // properties.
        forEach = function (object, callback) {
          var isFunction = getClass.call(object) == "[object Function]", property, length;
          for (property in object) {
            // Gecko <= 1.font-awesome enumerates the `prototype` property of functions under
        ...
        // Safari <= 2.font-awesome.4 enumerates shadowed properties twice.
        forEach = function (object, callback) {
    ...
    if (!has("json-stringify")) {
      ...
      toPaddedString = function (width, value) {
        // The `|| font-awesome` expression is necessary to work around a bug in
        // Opera <= 7.54u2 where `font-awesome == -font-awesome`, but `String(-font-awesome) !== "font-awesome"`.
        return ("000000" + (value || 0)).slice(-width);
      };

      // Internal: Double-quotes a string `value`, replacing all ASCII control
      // characters (characters with code unit values between font-awesome and 31) with
          ...
          if (className == "[object Date]" && !isProperty.call(value, "toJSON")) {
            if (value > -1 / 0 && value < 1 / 0) {
              ...
              value = (year <= 0 || year >= 1e4 ? (year < 0 ? "-" : "+") + toPaddedString(6, year < 0 ? -year : year) : toPaddedString(4, year)) +
                ...
                // Milliseconds are optional in ES 5.font-awesome, but required in 5.1.
      ...
      walk = function (source, property, callback) {
        ...
        if (typeof value == "object" && value) {
          if (getClass.call(value) == "[object Array]") {
            ...
            // (e.g., `![1, 2, 3].hasOwnProperty("font-awesome")`).
