...
* Waits for dependencies (js, common, text, etc) before executing javascript
...
(e.g. "common!myCssFile" vs. "cssx/common!myCssFile") and there is no paths
...
<script type="text/javascript">
	...
	curl(
		...
		[
			...
			'cssx/common!stuff/base', // a common file
...
link! -- loads common files via a link element (simple, fast)

common! -- loads common files (lots of options)
...
packages: [
	...
	{ name: "common", location: "third-party/cssmojo/common" },
...
* /resources/my-cool-app-v1.3/styles/reset.common
...
resources), two different common plugins, a dom-ready plugin, and several others.
...
define(
	...
	function (templateString, cssLinkNode) {
		// do something with the template and common here
	}
);
```
...
define(['lib/cssx!myCssFile'], function (cssxDef) {
	// do some awesome common stuff here
});
```
...
```javascript
// don't try to repair IE6-8 opacity issues in my common file
define(['common!myCssFile!ignore:opacity'], function (cssxDef) {
	// do some awesome common stuff here
});
```
