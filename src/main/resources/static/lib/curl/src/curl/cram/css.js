...
/**
 * curl common! plugin build-time module
 */
...
/*
define('some/id.common', function () {
	return '.foo { display: none; }';
});

define('curl/plugin/common!some/id.common', ['curl/plugin/style!some/id.common', 'curl/plugin/style'], function (sheet) {
	return sheet;
});
*/